...
export function ScrollToLessonButton({
  ...
  return (
    <motion.button
      ...
      className="fixed bottom-24 hover:cursor-pointer z-200 lg:bottom-10 2xl:right-190 lg:right-95 xl:right-115 right-4 border-3 shadow bg-duoGrayLockedShadow shadow-duoDarkGray  border-duoGrayLocked rounded-2xl p-3"
