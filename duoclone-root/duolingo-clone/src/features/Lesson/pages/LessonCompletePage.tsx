...
export function LessonCompletePage() {
  ...
  if (lessonCompleteMutation.isError) return <p>Error: {lessonCompleteMutation.error.message}</p>;
    ...
    <div className="w-full h-full flex items-center flex-col py-8 px-3 justify-center">
      <div className="w-full h-full flex flex-col items-center justify-center">
        ...
        <div className="w-full flex flex-col items-center my-10">
          <p className="text-3xl text-duoGold">{lessonCompleteMutation.data?.message}</p>
        ...
        <div className="w-full flex gap-6 justify-center">
          <div className="bg-duoGold rounded-xl w-40 h-24 items-center flex flex-col p-1">
            ...
            <div className="bg-duoBackground w-full h-full rounded-xl flex items-center justify-center p-2">
              <p className="text-duoGold">{lessonCompleteMutation.data?.totalScore}</p>
            </div>
          </div>
      ...
      >
        <p className="text-duoGrayButtonText" onClick={() => navigate("/")}>End Lesson</p>
      </div>
    </div>
  );
}
